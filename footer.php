...
<footer class="site-footer" role="contentinfo">
            ...
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    ...
                    foreach ( $socials as $key => $s ) {
                        if ( get_theme_mod( 'appforge_social_' . $key, '' ) ) { $has_social = true; break; }
                    }
                    if ( $has_social ) : ?>
                    <div class="footer-social" role="list" aria-label="<?php esc_attr_e( 'Social media links', 'appforge' ); ?>">
                        <?php foreach ( $socials as $key => $s ) :
                            $url = get_theme_mod( 'appforge_social_' . $key, '' );
                            if ( ! $url ) continue; ?>
                        <a href="<?php echo esc_url( $url ); ?>" class="social-btn" role="listitem"
                           aria-label="<?php echo esc_attr( $s['label'] ); ?>" rel="noopener noreferrer" target="_blank">
    ...
    <div class="container">
        <div class="footer-bottom">
            <p>&copy; <?php echo esc_html( date( 'Y' ) ); ?> <?php echo esc_html( get_theme_mod( 'appforge_copyright', 'AppForge. All rights reserved.' ) ); ?></p>
            <nav aria-label="<?php esc_attr_e( 'Legal links', 'appforge' ); ?>">
                <?php if ( get_theme_mod( 'appforge_show_credit', true ) ) :
                ...
                ?>
                <span class="footer-credit"><?php esc_html_e( 'Designed by', 'appforge' ); ?>
                    <a href="<?php echo esc_url( $author_url ); ?>" rel="noopener noreferrer" target="_blank"><?php echo esc_html( $author_name ); ?></a>
                </span>
                <?php endif; ?>
                <a href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?>"><?php esc_html_e( 'Privacy', 'appforge' ); ?></a>
                <a href="<?php echo esc_url( home_url( '/terms/' ) ); ?>"><?php esc_html_e( 'Terms', 'appforge' ); ?></a>
                <a href="<?php echo esc_url( home_url( '/sitemap.xml' ) ); ?>"><?php esc_html_e( 'Sitemap', 'appforge' ); ?></a>
            </nav>
        </div>
    </div>
